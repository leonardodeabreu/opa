...
jQuery.extend( true, jQuery.magnificPopup.defaults, {
  ...
  gallery: {
    ...
    tNext: 'Próxima (seta direita)', // Alt text on right arrow
    tCounter: '%curr% de %total%' // Markup for "1 of 7" counter
  },
  image: {
    tError: '<a href="%url%">A imagem</a> não foi encontrada.' // Error message when image could not be loaded
  },
  ajax: {
    tError: '<a href="%url%">O conteudo</a> não foi carregado.' // Error message when ajax request failed
  }
});